function task1(example::Bool = false, example_number::Int = 1)::Int
    data =
        example ? readlines("day6/example_data.txt")[example_number] :
        read("day6/data.txt")
...
for example_number in 1:5
    println(
        "Day 6 Task 1 example $example_number: ",
        task1(true, example_number),
    )
end
...
for example_number in 1:5
    println(
        "Day 6 Task 2 example $example_number: ",
        task2(true, example_number),
    )
end
