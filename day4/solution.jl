...
function get_ranges_from_line(line::String)::Tuple{Tuple{Int,Int}, Tuple{Int,Int}}
...
function get_ranges(example::Bool=false)::Vector{Tuple{Tuple{Int,Int}, Tuple{Int,Int}}}
